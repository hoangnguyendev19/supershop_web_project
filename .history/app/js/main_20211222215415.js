window.addEventListener("load", function() {
                ...
                <div class="view__info">
                    ...
                    <div class="view__info-setup">
                        <div class="view__info-size">
                            ...
                            <div class="view__info-option view__size">
                        ...
                        <div class="view__info-size">
                            ...
                            <div class="view__info-option  view__color">
    ...
    modalView.forEach(item => item.addEventListener("click", function() {
        ...
        // const viewInfoList = document.querySelector(".view__info-list");
        ...
        // viewInfoOption.forEach(item => item.addEventListener("click", function(event) {
        //     viewSize.classList.toggle("is-appear");
        // }));
