window.addEventListener("load", function() {
                    ...
                    <div class="view__info-setup">
                        <div class="view__info-size">
                            ...
                            <div class="view__info-option option__size">
                                <span class="view__name-size">L</span>
                                ...
                                <ul class="view__info-list list__size">
                                    ...
                                    <li class="view__info-item item__size">XXL</li>
                                </ul>
                            </div>
                        </div>
                        <div class="view__info-size">
                            ...
                            <div class="view__info-option option__color">
                                <span class="view__name-color">Red</span>
                                <i class="fas fa-angle-down"></i>
                                <ul class="view__info-list list__color">
                                    ...
                                    <li class="view__info-item item__color">Orange</li>
                                </ul>
                            </div>
                        </div>
                    </div>
    ...
    modalView.forEach(item => item.addEventListener("click", function() {
        ...
        const viewNameSize = document.querySelector(".view__name-size");
        const viewNameColor = document.querySelector(".view__name-color");
        const viewInfoItem = document.querySelectorAll(".view__info-item");
        optionSize.addEventListener("click", function() {
            listSize.classList.toggle("is-appear");
        });
        viewInfoItem.forEach(item => item.addEventListener("click", function(event) {
            const text = event.target.textContent;
            viewNameSize.textContent = text;
        }));
